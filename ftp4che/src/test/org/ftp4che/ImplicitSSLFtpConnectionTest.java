...
public class ImplicitSSLFtpConnectionTest extends AbstractFtpConnectionTest {
	
	@Test
	public void connectPassiveWithoutProxy() {
		connectionProperties.setProperty("connection.type", "IMPLICIT_SSL_FTP_CONNECTION");
