...
public class ImplicitTLSWithCryptedDataFtpConnectionTest extends AbstractFtpConnectionTest {

	@Test
	public void connectPassiveWithoutProxy() {
		connectionProperties.setProperty("connection.type", "IMPLICIT_TLS_WITH_CRYPTED_DATA_FTP_CONNECTION");
