...
public class ImplicitSSLWithCryptedDataFtpConnectionTest extends AbstractFtpConnectionTest {

	@Test
	public void connectPassiveWithoutProxy() {
		connectionProperties.setProperty("connection.type", "IMPLICIT_SSL_WITH_CRYPTED_DATA_FTP_CONNECTION");
