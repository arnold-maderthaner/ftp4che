...
public class UnknownFileParser implements FileParser {
	...
	public FTPFile parse(String serverLine,String parentDirectory) throws ParseException {
		...
		return new FTPFile("UNKNOWN NOT IMPLEMENTED YET!! If you can read this look at ftp4che.sf.net and give us some response because this should never happen :)","NOT IMPLEMENTED");
	}
